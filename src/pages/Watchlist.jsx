...
const Watchlist = () => {
    ...
    if(watchlist.length === 0 ){
        return(
            <div className="min-h-[70vh] flex flex-col justify-center text-center items-center text-app-muted px-4">
    ...
    return (
        <div className="p-6">
            <h1 className="text-3xl font-semibold text-app-text mb-8">My Watchlist</h1>
